#
#  Be sure to run `pod spec lint iOSUtil.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "wade.lu" => "wade.lu@bionime.com" }
  # Or just: s.author    = "wade.lu"
  # s.authors            = { "wade.lu" => "wade.lu@bionime.com" }
  # s.social_media_url   = "http://twitter.com/wade.lu"
